...
"""
"""
a function which calls conway_assignment_two . This function will contain a loop. Each
...
state history as a list.
 Do the same with conway_assignment_three without loop here this script using convolve2d from scipy
...
if __name__=='__main__':
    ...
    # print(board_states_assignment3)
    # plt.show()
